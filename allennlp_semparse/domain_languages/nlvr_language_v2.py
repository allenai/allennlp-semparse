...
class NlvrLanguageFuncComposition(DomainLanguage):
    ...
    """Can be accomplished using filter_function == object_shape_COND_equals(color)(object_in_box)"""
    # @predicate
    ...
    def object_shape_same(self, objects: Set[Object]) -> bool:
        return self.object_shape_count_equals(objects, 1)

    @predicate
    def object_color_same(self, objects: Set[Object]) -> bool:
        return self.object_color_count_equals(objects, 1)

    @predicate
    def object_shape_different(self, objects: Set[Object]) -> bool:
        return self.object_shape_count_not_equals(objects, 1)

    @predicate
    def object_color_different(self, objects: Set[Object]) -> bool:
        return self.object_color_count_not_equals(objects, 1)
