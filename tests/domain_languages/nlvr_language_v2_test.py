...
class TestNlvrLanguage(SemparseTestCase):
    ...
    def test_complex_action_sequence_execution(self):
        language = self.languages[0]
        action_sequence = [
            "@start@ -> bool",
            "bool -> [<int,Set[Box]:bool>, int, Set[Box]]",
    ...
    def test_get_agenda_for_sentence_correctly_adds_object_filters(self):
        ...
        assert "<Set[Box]:bool> -> box_exists" in agenda
        assert "<Set[Box],<Set[Object]:bool>:Set[Box]> -> box_filter" in agenda
        assert "Set[Box] -> all_boxes" in agenda
